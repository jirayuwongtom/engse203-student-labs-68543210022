...
| 15:25 | B1.5 | bug ที่ 5 พอกดลบแล้วหน้าจอขาวใน console มี error แจ้ง แต่ในโจทย์บอกว่า กด "ลบ" แล้วการ์ดหาย แต่ตัวเลขในแผงสรุปไม่ลด เกิดจากอะไร | ที่จริงตอนที่คุณเจอปัญหา "กด Refresh  แล้วเป็น 0" แล้วผมให้เติมตัวแปรเข้าไปในตอนนั้นนั่นแหละคือการ แก้บั๊กที่ 5 ไปล่วงหน้าแล้ว| - |
|  |  |  |  |  |
|  |  |  |  |  |
|  |  |  |  |  |
