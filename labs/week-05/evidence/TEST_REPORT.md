...
| TC-L5-23 | Pages Incognito + hash refresh | ในโหมดไม่ระบุตัวตน หน้าเว็บโหลดและ refresh ได้ปกติ ไม่มีหน้า 404 มีข้อมูลตั้งต้น 3 รายการโผล่มาโดยไม่มีข้อความกู้ข้อมูล | NOT RUN | `images/pages-incognito.png` + URL |
