...
| **ผู้จัดทำ**              | จิรายุ วงศ์ต่อม 68543210022-8           |
| **วันที่ปรับปรุงล่าสุด**  | 18/09/2569                              |
...
**ทำอะไร** `อัปเดตสถานะการดำเนินการตามคำร้องที่ระบุ`
...
| -------- | ------------ | ----------------------------------------------------------------- | :-------: |
| 1.0.0    | `17/09/2569` | เวอร์ชันแรก — GET, POST                                           |     —     |
| 2.0.0    | `18/09/2569` | เพิ่ม `PUT /api/requests/:id`,`DELETE /api/requests/:id` และ CORS |    ไม่    |
